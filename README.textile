...
For projects which use Maven, SesameTools snapshots and release packages can be imported from the "fortytwo.net Maven repository":http://fortytwo.net/maven2 by adding configuration like the following to your POM:
...
The latest packages can be browsed "here":http://fortytwo.net/maven2/net/fortytwo/sesametools.
