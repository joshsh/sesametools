...
public class RdfListUtilTest 
{
	...
	public void setUp()
	{
        ...
        testListHeadUri1 = vf.createURI("http://examples.net/testlisthead/1");
        testListHeadBNode1 = vf.createBNode();
	...
	/**
	 * Test method for {@link net.fortytwo.sesametools.RdfListUtil#addListAtNode(org.openrdf.model.Resource, org.openrdf.model.URI, java.util.List, org.openrdf.model.Graph, org.openrdf.model.Resource[])}.
	 */
	@Test
	public void testAddListEmptyNoContext() 
	{
		RdfListUtil.addListAtNode(testSubjectUri1, testPredicateUri1, testValuesEmpty, testGraph);
	...
	{
		RdfListUtil.addListAtNode(testSubjectUri1, testPredicateUri1, testValuesSingleUri, testGraph);
	...
	public void testGetListAfterInvalidGraphOperation() 
	{
        ...
        Assert.assertFalse(testGraph.contains(matchedStatement));
	...
	public void testGetListsSingleNullContext()
	{
        ...
        Resource headNode = (Resource)matchedStatement.getObject();
        
        
        
        Map<Resource, Set<Resource>> heads = new HashMap<Resource, Set<Resource>>();
        
        Set<Resource> headContexts = new TreeSet<Resource>();
