...
public class URITranslatorTest
{
    ...
    /**
     * Test method for {@link net.fortytwo.sesametools.URITranslator#doTranslation(org.openrdf.repository.Repository, java.lang.String, java.lang.String, java.util.Collection, java.util.Collection, java.util.Collection, boolean, org.openrdf.model.Resource[])}.
     * @throws UpdateExecutionException 
     * @throws MalformedQueryException 
     * @throws RepositoryException 
     */
    @Test
    public void testDoTranslationNoMappingOneContext() throws RepositoryException, MalformedQueryException, UpdateExecutionException 
    {
        ...
        for(Statement nextBeforeStatement : testRepositoryConnection.getStatements(null, null, null, false, testContext1).asList())
        {
            LOGGER.info("nextBeforeStatement: "+nextBeforeStatement.toString());
        }
        
        URITranslator.doTranslation(testRepository, testInputUriPrefix1, testOutputUriPrefix1, testSubjectMappingPredicatesEmpty, testPredicateMappingPredicatesEmpty, testObjectMappingPredicatesEmpty, testDeleteTranslatedTriplesTrue, testContext1);
        
        for(Statement nextAfterStatement : testRepositoryConnection.getStatements(null, null, null, false, testContext1).asList())
        {
